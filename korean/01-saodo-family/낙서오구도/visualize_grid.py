...
# Values and coordinates of the 33 nodes on the grid
VALUES = {
    (1, 3): 23, (3, 3): 28, (5, 3): 21,
    (0, 2): 20, (1, 2): 4, (2, 2): 16, (3, 2): 9, (4, 2): 14, (5, 2): 2, (6, 2): 33,
    (1, 1.5): 22, (3, 1.5): 18, (5, 1.5): 15,
    (0, 1): 31, (1, 1): 3, (2, 1): 19, (3, 1): 5, (4, 1): 26, (5, 1): 7, (6, 1): 25,
    (1, 0.5): 10, (3, 0.5): 17, (5, 0.5): 12,
    (0, 0): 29, (1, 0): 8, (2, 0): 11, (3, 0): 1, (4, 0): 24, (5, 0): 6, (6, 0): 30,
    (1, -1): 27, (3, -1): 32, (5, -1): 13,
}

PALACE_CENTERS = {
    "upper_left": (1, 2), "upper_center": (3, 2), "upper_right": (5, 2),
    "middle_left": (1, 1), "center": (3, 1), "middle_right": (5, 1),
    "lower_left": (1, 0), "lower_center": (3, 0), "lower_right": (5, 0),
}

DISPLAY_LABELS = {
    "upper_left": "상좌궁", "upper_center": "상중궁", "upper_right": "상우궁",
    "middle_left": "중좌궁", "center": "중궁", "middle_right": "중우궁",
    "lower_left": "하좌궁", "lower_center": "하중궁", "lower_right": "하우궁",
}
...
def draw_grid_overview():
    ...
    # Draw palace boundary circular guides
    ...
    for palace_name, (x, y) in PALACE_CENTERS.items():
        ...
        ax.text(x, label_y, f"{DISPLAY_LABELS[palace_name]} (합 85)", ha="center", va="center", fontproperties=font, fontsize=9, color="#666666", zorder=1)
    ...
    vertical_columns = (
        ((1, 3), (1, 2), (1, 1.5), (1, 1), (1, 0.5), (1, 0), (1, -1)),
        ((3, 3), (3, 2), (3, 1.5), (3, 1), (3, 0.5), (3, 0), (3, -1)),
        ((5, 3), (5, 2), (5, 1.5), (5, 1), (5, 0.5), (5, 0), (5, -1)),
    )
    ...
    plt.title("낙서오구도 (오자각득) 전역 그물형 격자 시각화", fontproperties=font, fontsize=15, pad=15)
    plt.tight_layout()
