...
8. **08-modn-antipodal** — 위치 대칭 보수쌍 도안의 mod N 잉여류 일반화 (교차 장 분석)
...
`03-magic-squares/`에는 육육도·구수도와 10×10 백자 계통의 원 배열 및 검산
결과가 들어 있습니다. 백자 계통은 원문 전사를 그대로 분석하며, 마방진 조건에
맞춘 정규화 배열은 만들지 않습니다. 별도로 문서화한 백자도 재배열은 행·열 합이
505인 준마방진입니다.
...
- **목표 조건**: 대척 보수쌍 합 271, 고리 k 합 813k, 변당 합 1355, 축 합 2439, 섹터 합 6097/6098, 광선 합 1219/1220
