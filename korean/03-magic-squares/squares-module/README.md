...
| **순수도 (순수 방진)**<br>백자생성순수도 교정본 | ![Pure Square](./figures/m04_pure.png) | 아들 방진($M_{03}$)을 원점 기준으로 90도 회전($M_{03}$의 rot90)하여 도출된 방진입니다. |
| **교수도 (교사 방진)**<br>백자생성교수도 교정본 | ![Cross Square](./figures/m05_cross.png) | 아들 방진($M_{03}$)을 좌우 대칭축을 기준으로 뒤집은($M_{03}$의 fliplr) 대칭 방진입니다. |
