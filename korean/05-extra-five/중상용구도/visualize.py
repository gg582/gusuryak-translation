...
def plot_magic_star():
    # 1. 도안의 기하학적 대칭성을 고려한 33개 노드 좌표 정의
    coords = {
    ...
    plt.title("Gusu-ryak: Heavy Hexagonal Star (중상용구도)", fontsize=16, fontweight='bold', pad=20)
    
    # 3. 147 상수를 만족하는 대표 대칭축 연결선 그리기
    # 세로 중심축 (합: 147)
    ...
    # 4. 노드 렌더링 (외곽 경계 노드와 내측 노드 색상 구분)
    for num, pos in coords.items():
        ...
        plt.text(pos[0], pos[1], str(num), fontsize=12, fontweight='bold', ha='center', va='center', zorder=4)
