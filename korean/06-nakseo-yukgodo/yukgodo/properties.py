...
class PropertyReport:
    ...
    axis_sums: list[int]                 # 축 3개 (中觔 포함)
    pair_devs: list[int]                 # 대점쌍 합 - 271, 슬롯별
