...
이 스크립트는 수전사 업데이트로 규명된 '五百四(504)', '去중觚(중고 제외)' 등을 포함하여
...
dag.add("V19", 19, "V20 - C1", "20 - 1 = 19 (減一為十九 - 중고 수)")
...
# 신규 수전사 업데이트 분기 (외주 54 * 고리 9 = 486 -> 486 / 2 + 9 = 252)
dag.add("V486", 486, "C54 * C9", "외주 * 고리 수 = 486 (외주乘九得/乘之得四百八十六)")
dag.add("V252_NEW", 252, "V486 // C2 + C9", "486 / 2 + 9 = 252 (折半加九得二百五十二)")

# 504 배배(倍之) 및 중고 제외(去중觚) 수전사 핵심 사슬
dag.add("V504", 504, "V252_COMB * C2", "252 * 2 = 504 (二百五十二倍之得五百사)")
dag.add("V504_NEW", 504, "V252_NEW * C2", "252 * 2 = 504 (二百五두倍之得五百사 - 신규 사슬)")
...
dag.add("V18_AXIS", 18, "V19 - C1", "19 - 1 = 18 (중고의 실사용 칸 수)")
dag.add("V252_GEOM", 252, "V270_GEOM - V18_AXIS", "270 - 18 = 252 (합종구목 - 중고 제외 = 252 (不倍, 去中觚))")
