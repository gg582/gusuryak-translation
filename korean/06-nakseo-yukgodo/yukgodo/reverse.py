...
def annotation_crosscheck(analysis: dict) -> list[dict]:
    ...
    return [
        ...
        {
            "fragment": "倍之得五百四 / 折半淂二百五十二",
            "reading": "252를 두 배 하여 504를 얻고, 이를 절반으로 나누어 252를 얻음",
            "status": "확정 (1급)",
            "evidence": "二百五十二(252)의 2배인 504(五百四) 및 절반인 252와 정확히 일치. 기존 판독인 五百(500)/五百六(506)은 오독으로 판명",
        },
        {
            "fragment": "合從九目淂二百五十二不倍 / 去中觚",
            "reading": "9개 고리를 결합하여 중구를 제외하면 252를 얻으며 배가 아님",
            "status": "확정 (1급)",
            "evidence": "9개 고리 전체 칸 수(270)에서 중구(中觚)의 중심 제외 칸 수(18)를 제거하면 252가 되며, 이는 기하학적 칸 수의 직접적인 정의와 부합함",
        },
        {
            "fragment": "寄左 / 序左",
