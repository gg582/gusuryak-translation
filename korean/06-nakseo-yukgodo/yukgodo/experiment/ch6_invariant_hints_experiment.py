...
1. 기존 결정론적 솔버가 '절대 못 만든 참인 해(Unreachable Valid Solution)' v_unreachable 에 대하여,
   핵심 기하학적 불변량(Invariant Hints: 대척쌍 271, 고리 813k, 축 2439 등)이
...
def verify_invariant_hints(grid: HexGrid, outdir: str = "yukgodo/experiment") -> dict:
    ...
    print("==========================================================================")
    print("  제 6 장: 고립 해(Unreachable Solutions)의 핵심 기하 불변량 힌트 수리 검증")
    print("==========================================================================")
    ...
    # 힌트 4: C6 x Z2 대칭군 궤도 복원율 (Orbit Restoration Rate)
    ...
    print(f"  4. C6 x Z2 궤도 100% 복원 가능성:      {'통과 (True)' if hint4_pass else '실패'}")
    ...
    report = {
        ...
        "conclusion": (
            ...
            "무작위 무질서가 아니라, 핵심 기하학적·수학적 불변량(Invariants)을 품고 있음을 증명함.\n"
            "2. 대척쌍 271, 고리 813k, 축 2439 및 C6 대칭군 궤도 연산자를 '생성 힌트(Generative Operators)'로 "
