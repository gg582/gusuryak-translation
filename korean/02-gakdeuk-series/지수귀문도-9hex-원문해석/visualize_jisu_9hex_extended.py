...
def draw_multiplicity(
    ...
    text = (
        f"三十子作 (made): {node_count} numbers\n"
        f"五十四子用 (used): {total_used} positions\n"
...
def draw_center_periphery(
    ...
    ax.set_title(
        "中眷三宮：central three palaces (Hex2, Hex5, Hex8) govern the structure",
        fontsize=14, fontweight="bold", color="#2C3E50", pad=12,
    )
    ...
    explanation = (
        ...
        "The three central palaces correspond to 三宮爲主則."
    )
    ax.text(
