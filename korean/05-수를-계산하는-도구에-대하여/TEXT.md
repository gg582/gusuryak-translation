...
이렇게 되면 상수항은 문구점 주인으로 외부화되어 연산에서 빠진다. 자연히 연산 대상은 $f(x)=3x^3+2x$일 때 $f(30.28)-f(30)$이 되고, 그래프를 그리면 y축 기준으로 1칸 아래로 내려 간다.

이 때, ${f(30)}\gt{f(30.28)}$ 이기 때문에 구하고자 하는 변화량은 $f(30.28)-f(30)$이 되는 것이 일상 속 필요에 그 유래가 있다고 해석할 수도 있다.
