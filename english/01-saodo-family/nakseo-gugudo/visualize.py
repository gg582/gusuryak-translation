...
CLUSTERS: tuple[tuple[Cluster, ...], ...] = (
    (
        Cluster("8", (17, 35, 56, 26, 65, 46, 42, 74)),
        Cluster("1", (10, 28, 63, 19, 72, 54, 41, 81)),
        Cluster("6", (15, 33, 58, 24, 67, 47, 43, 76)),
    ),
    (
        Cluster("3", (12, 30, 61, 21, 70, 53, 40, 79)),
        Cluster("5", (14, 32, 59, 23, 68, 52, 39, 77)),
        Cluster("7", (16, 34, 57, 25, 66, 51, 38, 75)),
    ),
    (
        Cluster("4", (13, 31, 60, 22, 69, 48, 44, 78)),
        Cluster("0", (18, 36, 55, 27, 64, 50, 37, 73)),
        Cluster("2", (11, 29, 62, 20, 71, 49, 45, 80)),
    ),
)
